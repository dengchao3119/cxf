 ...
 * 2018-05-22T17:19:26.892+08:00
 * Generated source version: 3.2.3
 *
 */
@WebServiceClient(name = "Service",
                  wsdlLocation = "http://218.18.106.134:8099/Service.asmx?wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://218.18.106.134:8099/Service.asmx?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://218.18.106.134:8099/Service.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
